/* ========================================
   APPOINTMENTS.JS - Appointment Booking (COMPLETE FIX)
   ======================================== */
    ...
    setTimeout(() => {
        ...
        function loadDoctors() {
            ...
            doctorSelect.innerHTML = '<option value="">Select doctor</option>' +
                doctors.map(d => {
                    ...
                    return `<option value="${d.id}">${d.name} - ${d.specialty} [${shift}]</option>`;
                }).join('');
        }
        ...
        function handleFormSubmit(e) {
            ...
            try {
                ...
                setTimeout(() => {
                    if (confirm('Appointment confirmed! View your appointments?')) {
                        if (currentPatient) {
